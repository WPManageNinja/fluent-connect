...
use FluentConnect\Framework\Support\UrlRoutable;
use FluentConnect\Framework\Database\Orm\DateTime;
use FluentConnect\Framework\Foundation\Dispatcher;
use FluentConnect\Framework\Support\QueueableEntity;
use FluentConnect\Framework\Support\JsonableInterface;
use FluentConnect\Framework\Support\ArrayableInterface;
use FluentConnect\Framework\Database\Orm\Relations\Pivot;
use FluentConnect\Framework\Database\Orm\Relations\HasOne;
use FluentConnect\Framework\Database\Orm\ModelHelperTrait;
use FluentConnect\Framework\Database\Orm\Relations\MorphTo;
use FluentConnect\Framework\Database\Orm\Relations\HasMany;
use FluentConnect\Framework\Database\Orm\Relations\MorphOne;
use FluentConnect\Framework\Database\Orm\Relations\MorphMany;
use FluentConnect\Framework\Database\Orm\Relations\Relation;
use FluentConnect\Framework\Database\Orm\Relations\BelongsTo;
use FluentConnect\Framework\Database\Orm\Relations\MorphToMany;
use FluentConnect\Framework\Support\Collection as BaseCollection;
use FluentConnect\Framework\Database\Orm\Relations\BelongsToMany;
use FluentConnect\Framework\Database\Orm\Relations\HasManyThrough;
use FluentConnect\Framework\Database\Query\Builder as QueryBuilder;
use FluentConnect\Framework\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity, UrlRoutable
{
	 ...
	 *
	 * @var \FluentConnect\Framework\Database\ConnectionResolverInterface
	 */
	 ...
	 *
	 * @var \FluentConnect\Framework\Foundation\Dispatcher
	 */
     ...
     *
     * @param  \FluentConnect\Framework\Database\Eloquent\Scope|\Closure|string  $scope
     ...
     *
     * @param  \FluentConnect\Framework\Database\Eloquent\Scope|string  $scope
     * @return bool
     */
     ...
     *
     * @param  \FluentConnect\Framework\Database\Eloquent\Scope|string  $scope
     * @return \FluentConnect\Framework\Database\Eloquent\Scope|\Closure|null
     */
     ...
     * @return $this
     *
     * @throws \FluentConnect\Framework\Database\Eloquent\MassAssignmentException
     */
     ...
     * @param  array  $items
     * @param  string|null  $connection
     * @return \FluentConnect\Framework\Database\Eloquent\Collection
     */
     ...
     *
     * @return \FluentConnect\Framework\Database\Eloquent\Builder
     */
     ...
     * @return \FluentConnect\Framework\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  array|string  $relations
     * @return \FluentConnect\Framework\Database\Eloquent\Builder|static
     */
     ...
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\HasMany
     */
     ...
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  string  $relation
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\BelongsToMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\MorphToMany
     */
     ...
     *
     * @param  \FluentConnect\Framework\Database\Eloquent\Builder  $query
     * @param  array  $options
     * @return bool
     */
     ...
     *
     * @return \FluentConnect\Framework\Database\Orm\DateTime
     */
     ...
     *
     * @param  \FluentConnect\Framework\Database\Query\Builder  $query
     * @return \FluentConnect\Framework\Database\Eloquent\Builder|static
     */
     ...
     *
     * @param  \FluentConnect\Framework\Database\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @return \FluentConnect\Framework\Database\Eloquent\Relations\Pivot
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'FluentConnect\Framework\Database\Eloquent\Relations\Relation');
        }
     ...
     * @return \FluentConnect\Framework\Database\Eloquent\Model
     */
     ...
     *
     * @return \FluentConnect\Framework\Database\Connection
     */
     ...
     *
     * @return \FluentConnect\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \FluentConnect\Framework\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     *
     * @return \FluentConnect\Framework\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \FluentConnect\Framework\Foundation\Dispatcher  $dispatcher
     * @return void
     */
