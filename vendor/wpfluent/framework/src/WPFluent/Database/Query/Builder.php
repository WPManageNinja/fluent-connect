...
use FluentConnect\Framework\Pagination\LengthAwarePaginator;
...
class Builder
{
     ...
     *
     * @var \FluentConnect\Framework\Database\Query\WPDBConnection
     */
     ...
     * @param  \FluentConnect\Framework\Database\Query\Grammar  $grammar
     * @param  \FluentConnect\Framework\Database\Query\Processor  $processor
     * @return void
     */
     ...
     * @return \FluentConnect\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @param  \FluentConnect\Framework\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
    ...
    public function dynamicWhere($method, $parameters)
    {
        ...
        // The connect variable will determine which connect will be used for the
        ...
        foreach ($segments as $segment) {
            // If the segment is not a boolean connect, we can assume it is a column's name
            ...
            // Otherwise, we will store the connect so we know how the next where clause we
            // find in the query should be connected to the previous ones, meaning we will
            // have the proper boolean connect to connect the next where clause found.
            else {
                $connector = $segment;
            }
        }
