...
namespace FluentConnect\Framework\Database\Query;
...
use FluentConnect\Framework\Pagination\Paginator;
use FluentConnect\Framework\Support\ForwardsCalls;
use FluentConnect\Framework\Support\LazyCollection;
use FluentConnect\Framework\Database\Query\Grammar;
use FluentConnect\Framework\Database\Query\Processor;
use FluentConnect\Framework\Support\ArrayableInterface;
use FluentConnect\Framework\Database\ConnectionInterface;
use FluentConnect\Framework\Database\Concerns\BuildsQueries;
use FluentConnect\Framework\Database\Concerns\ExplainsQueries;
use FluentConnect\Framework\Database\Orm\Relations\Relation;
use FluentConnect\Framework\Database\Orm\Builder as OrmBuilder;
...
class Builder
{
     ...
     *
     * @var \FluentConnect\Framework\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \FluentConnect\Framework\Database\Query\Grammar
     */
    public $grammar;
     ...
     *
     * @var \FluentConnect\Framework\Database\Query\Processor
     */
    public $processor;
     ...
     *
     * @param  \FluentConnect\Framework\Database\ConnectionInterface  $connection
     * @param  \FluentConnect\Framework\Database\Query\Grammar|null  $grammar
     * @param  \FluentConnect\Framework\Database\Query\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\FluentConnect\Framework\Database\Query\Builder|\FluentConnect\Framework\Database\Orm\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\FluentConnect\Framework\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Closure|\FluentConnect\Framework\Database\Query\Builder|string  $table
     ...
     *
     * @param  \FluentConnect\Framework\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \FluentConnect\Framework\Database\Query\JoinClause
     */
     ...
     *
     * @param  string  $column
     * @param  \FluentConnect\Framework\Support\ArrayableInterface|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|\FluentConnect\Framework\Database\Query\Expression  $column
     * @param  array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @param  \FluentConnect\Framework\Database\Query\Expression|string  $column
     * @param  string  $operator
     ...
     *
     * @param  \Closure|\FluentConnect\Framework\Database\Orm\Builder|\FluentConnect\Framework\Database\Query\Builder|\FluentConnect\Framework\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\FluentConnect\Framework\Database\Query\Builder|\FluentConnect\Framework\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \FluentConnect\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @param  int|null  $page
     * @return \FluentConnect\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentConnect\Framework\Pagination\PaginatorInterface
     */
     ...
     * @param  \FluentConnect\Framework\Pagination\Cursor|string|null  $cursor
     * @return \FluentConnect\Framework\Pagination\CursorPaginatorInterface
     */
     ...
     *
     * @return \FluentConnect\Framework\Support\LazyCollection
     */
     ...
     *
     * @param  mixed  $value
     * @return \FluentConnect\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \FluentConnect\Framework\Database\ConnectionInterface
     */
     ...
     *
     * @return \FluentConnect\Framework\Database\Query\Processor
     */
     ...
     *
     * @return \FluentConnect\Framework\Database\Query\Grammar
     */
