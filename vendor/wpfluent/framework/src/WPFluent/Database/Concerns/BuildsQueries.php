...
use FluentConnect\Framework\Support\Conditionable;
...
trait BuildsQueries
{
     ...
     * @return \FluentConnect\Framework\Database\Orm\Model|object|static|null
     */
     ...
     * @return \FluentConnect\Framework\Database\Orm\Model|object|static|null
     *
     * @throws \FluentConnect\Framework\Database\RecordsNotFoundException
    ...
    protected function paginateUsingCursor($perPage, $columns = ['*'], $cursorName = 'cursor', $cursor = null)
    {
        ...
        if (! is_null($cursor)) {
            $addCursorConditions = function (self $builder, $previousColumn, $i) use (&$addCursorConditions, $cursor, $orders) {
                $unionBuilders = isset($builder->unions) ? Helper::collect($builder->unions)->pluck('query') : Helper::collect();
     ...
     *
     * @param  \FluentConnect\Framework\Database\Query\Builder|\FluentConnect\Framework\Database\Orm\Builder  $builder
     ...
     *
     * @param  \FluentConnect\Framework\Support\Collection  $items
     * @param  int  $total
     * @param  int  $perPage
     * @param  int  $currentPage
     * @param  array  $options
     * @return \FluentConnect\Framework\Pagination\LengthAwarePaginator
     */
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \FluentConnect\Framework\Pagination\Paginator
     */
     ...
     * @param  \FluentConnect\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \FluentConnect\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \FluentConnect\Framework\Pagination\CursorPaginator
     */
