...
use FluentConnect\Framework\Validator\Rules\In;
use FluentConnect\Framework\Validator\Rules\NotIn;
use FluentConnect\Framework\Validator\Rules\Unique;
use FluentConnect\Framework\Validator\Rules\Exists;
use FluentConnect\Framework\Validator\Rules\RequiredIf;
use FluentConnect\Framework\Validator\Rules\Dimensions;
use FluentConnect\Framework\Validator\Rules\ConditionalRules;
...
class Rule
{
     ...
     * @return \FluentConnect\Framework\Validator\Rules\ConditionalRules
     */
     ...
     * @return \FluentConnect\Framework\Validator\Rules\Dimensions
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentConnect\Framework\Validator\Rules\Exists
     */
     ...
     * @return \FluentConnect\Framework\Validator\Rules\In
     */
     ...
     *
     * @param  \Illuminate\Contracts\Support\Arrayable|array|string  $values
     * @return \FluentConnect\Framework\Validator\Rules\NotIn
     */
     ...
     * @return \FluentConnect\Framework\Validator\Rules\RequiredIf
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentConnect\Framework\Validator\Rules\Unique
     */
